...
import static cn.edu.fc.javaee.core.model.Constants.BEGIN_TIME;
import static cn.edu.fc.javaee.core.model.Constants.END_TIME;
...
public class ControllerAspect {
    ...
    @Value("${schedulesystem.core.page-size.max}")
    private int max_page_size;

    @Value("${schedulesystem.core.page-size.default}")
     ...
     * @throws Throwable
     */
    @Around("cn.edu.fc.javaee.core.aop.CommonPointCuts.controllers()")
