...
public class CommonTest {
    ...
    public void cloneObj2(){
        ...
        RefundTrans bo = Common.cloneObj(po, RefundTrans.class);
        Assertions.assertEquals(Long.valueOf(1), bo.getId());
        assertEquals("Ref001", bo.getOutNo());
        Assertions.assertEquals(Long.valueOf(2), bo.getCreatorId());
        Assertions.assertEquals("管理员",bo.getCreatorName());
        Assertions.assertEquals(now, bo.getGmtCreate());
        Assertions.assertEquals(now.minusDays(Long.valueOf(1)), bo.getGmtModified());
    ...
    public void clearFields1(){
        ...
        boolean ret = Common.clearFields(po, "id","outNo","transNo");
        assertTrue(ret);
    ...
    public void putUserFields2(){
        ...
        user.setName("test1");
        user.setUserLevel(1);
        Common.putUserFields(bo, "modifier", user);
        Assertions.assertEquals(2, bo.getModifierId());
        Assertions.assertEquals("test1", bo.getModifierName());
    ...
    public void cleanFields1() {
        RefundTrans bo = new RefundTrans();
        bo.setId(1L);
        bo.setUserReceivedAccount("hello");
        Common.clearFields(bo, "id");
        assertNull(bo.getUserReceivedAccount());
    }
}
